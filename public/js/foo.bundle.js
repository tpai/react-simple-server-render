	...
	var HyperLink = function (_Component) {
	    ...
	    _createClass(HyperLink, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            var location = this.context.router.createLocation(to);
	            (0, _reactRouter.match)({
	                routes: routes,
	                location: location.pathname
	            }, function (err, redirect, props) {
	                _this2.setState({ outer: !props });
	            });
	        }
	    }, {
	        key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _foo = __webpack_require__(225);
	...
	exports.default = _react2.default.createElement(
	    _reactRouter.Route,
	    { path: '/foo', component: _Layout2.default },
	    _react2.default.createElement(_reactRouter.Route, { path: '1', components: { sidebar: _Sidebar2.default, content: Foo1 } }),
	    _react2.default.createElement(_reactRouter.Route, { path: '2', components: { sidebar: _Sidebar2.default, content: Foo2 } })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:5]!./../../../node_modules/postcss-loader/index.js!./foo.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]__[hash:base64:5]!./../../../node_modules/postcss-loader/index.js!./foo.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".foo__item__1kPry {\n    color: red;\n}\n", ""]);

	// exports
	exports.locals = {
		"item": "foo__item__1kPry"
	};
